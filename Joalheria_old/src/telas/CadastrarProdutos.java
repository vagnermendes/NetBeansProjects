...
public class CadastrarProdutos extends javax.swing.JPanel {
    ...
    public CadastrarProdutos(Kernel obj,int acao,Object texto) {
        kernel = obj;      
    ...
    private void Salvar(){
        ...
        if(Id.getText().equals("0")){            
            ...
            obj_Produtos.setPreco_custo(Double.parseDouble((campo_peso.getText().equals("")?"0.0":campo_peso.getText().replace(",", "."))));            
            obj_Produtos.setPreco_promocional(Double.parseDouble((campo_quantidade.getText().equals("")?"0.0":campo_quantidade.getText().replace(",", "."))));
    ...
    private void PreencherFormulario(int acao) {
        try {
           ...
           obj_Produtos = bd_Produtos.getProdutos(acao);
           
           campo_nome.setText(obj_Produtos.getNome());
           campo_precovenda.setText(String.valueOf((obj_Produtos.getPreco_venda()==0.0)?"":obj_Produtos.getPreco_venda()));
           campo_precocusto.setText(String.valueOf((obj_Produtos.getPreco_custo()==0.0)?"":obj_Produtos.getPreco_custo()));
           campo_precopromocional.setText(String.valueOf((obj_Produtos.getPreco_promocional()==0.0)?"":obj_Produtos.getPreco_promocional()));
