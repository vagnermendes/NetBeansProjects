...
public class CadastrarEmpresa extends javax.swing.JPanel {
    ...
    private void Salvar(){
        ...
        if(Empresa_id.getText().equals("0")){            
            ...
            obj_Empresa.setCep(Integer.parseInt((campo_cep.getText().equals("")?"0":campo_cep.getText())));
    ...
    private void PreencherFormulario(int acao) {
        try {
           ...
           campo_cep.setText(String.valueOf((obj_Empresa.getCep()==0)?"":obj_Empresa.getCep()));
