...
public class Imprimir {
   ...
   if (pj != null) {
      ...
      g.drawImage((new ImageIcon(getClass().getResource("favicon.png")).getImage()), 520, 40, null);
      ...
      g.drawString( (ordem.getCliente().getEndereco()!=null?ordem.getCliente().getEndereco():"")+" "+(ordem.getCliente().getNumero()!=null?ordem.getCliente().getNumero():"") , 350, 105);
      g.drawString( (ordem.getCliente().getBairro()!=null?ordem.getCliente().getBairro():"")+"  "+(ordem.getCliente().getCidade()!=null?ordem.getCliente().getCidade():"")+" "+(ordem.getCliente().getUf()!=null?ordem.getCliente().getUf():"") , 350, 120);
      ...
      //g.drawRoundRect(20, 163, 500, 150, 25, 25);
        ...
        g.setFont(new Font("Courier New",Font.PLAIN,10));
           ...
           int linha = 160;
                        ...
                        g.drawString( "PRODUTO: "+ ordem.getProduto() , 30, linha);
                        g.drawString( "MATERIAL: "+ ordem.getModelo() , 30, linha+10);
                        g.drawString( "MARCA: "+ ordem.getReferencia(), 30, linha+20);
      ...
      g.setFont(new Font("Courier New",Font.BOLD,10));
      g.drawString( "-------------------------------------------------------------------------------------------------" , 5, 393);
      g.drawImage((new ImageIcon(getClass().getResource("favicon.png")).getImage()), 520, 415, null);
      ...
      g.setFont(new Font("Courier New",Font.PLAIN,10));
      g.drawString( (ordem.getCliente().getEndereco()!=null?ordem.getCliente().getEndereco():"")+" "+(ordem.getCliente().getNumero()!=null?ordem.getCliente().getNumero():"") , 350, 475);
      g.drawString( (ordem.getCliente().getBairro()!=null?ordem.getCliente().getBairro():"")+"  "+(ordem.getCliente().getCidade()!=null?ordem.getCliente().getCidade():"")+" "+(ordem.getCliente().getUf()!=null?ordem.getCliente().getUf():"") , 350, 490);
      ...
      String txt2 = ordem.getDescricao();
        ...
        g.setFont(new Font("Courier New",Font.PLAIN,10));
           ...
           int linha2 = 532;
                        ...
                        g.drawString( "PRODUTO: "+ ordem.getProduto() , 30, linha2);
                        g.drawString( "MATERIAL: "+ ordem.getModelo() , 30, linha2+10);
                        g.drawString( "MARCA: "+ ordem.getReferencia() , 30, linha2+20);
