...
public class BD_OrdemServico  {
    ...
    public OrdemServico[] getOrdemServico() throws SQLException{
           ...
           // System.out.println(sql);
            ...
            OrdemServico OrdemServicos[] = new OrdemServico[((total==0)?0:total)];
    ...
    public OrdemServico getOrdemServicoID(int cod){
        try {
            sql = "select *,cl.nome as cliente_nome,"
                    ...
                    + "cl.ddd_tel as ddd,cl.telefone as telefone, "
                    + "cl.endereco as endereco,cl.numero as numero, "
                    + "cl.bairro as bairro,cl.cidade as cidade, cl.uf as uf, "
            ...
            while (rs.next()) {
                ...
                obj_cliente.setCliente_id(Integer.parseInt(rs.getString("cliente_id")));
                obj_cliente.setNome(rs.getString("cliente_nome"));
                obj_cliente.setCidade(rs.getString("cidade"));
                obj_cliente.setUf(rs.getString("uf"));
                obj_cliente.setNumero(rs.getString("numero"));
                obj_cliente.setBairro(rs.getString("bairro"));
                obj_cliente.setEndereco(rs.getString("endereco"));
    ...
    public int SalvarGetID(OrdemServico ordem) {
