...
public class BD_Receita{
    ...
    public void Salvar(Receita Receita){
        sql = "insert into "+esquema+"."+tabela+"(odla,odlc,odle,odli,odpa,odpc,odpe,odpi,oela,oelc,oele,oeli,oepa,oepc,oepe,oepi,lentes,observacao,cliente_id,"
    ...
    public void Excluir(int id){
        sql = "delete from "+esquema+"."+tabela+" where Receita_id = "+id;
