...
public class BD_Vendas {
    ...
    public void Salvar(Vendas Vendas){        
        sql = "insert into "+esquema+"."+tabela+"(data,hora,preco,preco_venda,entrada,restante,desconto,funcionario_id"+((Vendas.getDescricao()!=null)?",descricao":"")+",cliente_id"+((Vendas.getCartoes()!=null)?",cartoes_id":"")+""+((Vendas.getParcelas()!=null)?",parcelas_id":"")+") values ('"+(new SimpleDateFormat("yyyy-MM-dd").format(Vendas.getData()))+"','"+(new SimpleDateFormat("HH:mm").format(Vendas.getHora()))+"',"+Vendas.getPreco()+","+Vendas.getPreco_venda()+","+Vendas.getEntrada()+","+Vendas.getRestante()+","+Vendas.getDesconto()+","+Vendas.getFuncionario().getFuncionario_id()+((Vendas.getDescricao()!=null)?",'"+Vendas.getDescricao()+"'":"")+","+Vendas.getCliente().getCliente_id()+((Vendas.getCartoes()!=null)?","+Vendas.getCartoes().getCartoes_id():"")+""+((Vendas.getParcelas()!=null)?","+Vendas.getParcelas().getParcelas_id():"")+")";
    ...
    public int SalvarGetID(Vendas Vendas){   
        ...
        sql = "insert into "+esquema+"."+tabela+"(data,hora,preco,preco_venda,entrada,restante,desconto,funcionario_id"+((Vendas.getCliente().getCliente_id()!=0)?",cliente_id":"")+((Vendas.getCartoes()!=null)?",cartoes_id":"")+""+((Vendas.getParcelas()!=null)?",parcelas_id":"")+") values ('"+(new SimpleDateFormat("yyyy-MM-dd").format(Vendas.getData()))+"','"+(new SimpleDateFormat("HH:mm").format(Vendas.getHora()))+"',"+Vendas.getPreco()+","+Vendas.getPreco_venda()+","+Vendas.getEntrada()+","+Vendas.getRestante()+","+Vendas.getDesconto()+","+Vendas.getFuncionario().getFuncionario_id()+((Vendas.getCliente().getCliente_id()!=0)?","+Vendas.getCliente().getCliente_id():"")+((Vendas.getCartoes()!=null)?","+Vendas.getCartoes().getCartoes_id():"")+""+((Vendas.getParcelas()!=null)?","+Vendas.getParcelas().getParcelas_id():"")+" returning produtos_id)";
    ...
    public Vendas[] getRelatorio(int funcionario_id, String data1, String data2) throws SQLException, ParseException {
        ...
        rs = kernel.getConexao().Query(sql);
            ...
            Vendas vetor[] = new Vendas[total];
            sql = "select *,b.nome as funcionario_nome from "+esquema+"."+tabela+" a left join "+esquema+".funcionario b on a.funcionario_id=b.funcionario_id  where a.data between '"+data1+"' and '"+data2+"' "+((funcionario_id!=0)?"and a.funcionario_id="+funcionario_id:"");
            //System.out.println(sql);
            rs = kernel.getConexao().Query(sql);
            int contador = 0;
            while (rs.next()) {
