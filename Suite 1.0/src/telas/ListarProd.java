 ...
 * ListaProd.java
 *
 * Created on 26/03/2011, 20:50:09
 */
 ...
 */
public class ListarProd extends javax.swing.JPanel {
    ...
    public ListarProd(Kernel obj,int acao,Object texto) {
        kernel = obj;
        initComponents();                
        this.Tabela("");
    }
    ...
    private void initComponents() {
        ...
        painel_cadastrar_area3Layout.setHorizontalGroup(
            ...
            .add(painel_cadastrar_area3Layout.createSequentialGroup()
                ...
                .add(painel_cadastrar_area3Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(jLabel38, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 60, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
        ...
        painel_cadastrar_area3Layout.setVerticalGroup(
            ...
            .add(painel_cadastrar_area3Layout.createSequentialGroup()
                .add(painel_cadastrar_area3Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(painel_cadastrar_area3Layout.createSequentialGroup()
                        .add(adicionar, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 59, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Buscar"));
        ...
        tabela.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cod", "Nome", "Quantidade", "Editar", "Excluir"
            }
        ) {
        ...
        layout.setHorizontalGroup(
            ...
            .add(sp, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 631, Short.MAX_VALUE)
            .add(org.jdesktop.layout.GroupLayout.TRAILING, painel_cadastrar_area3, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
        layout.setVerticalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(sp, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 149, Short.MAX_VALUE))
        );
    ...
    private void campo_nomeKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_campo_nomeKeyPressed
        ...
        if(evt.getKeyCode()==10){
            if(!campo_codigobarras.getText().equals("")){
                Tabela(campo_codigobarras.getText());
    ...
    //TABELA Produtos
    public void Tabela(String obj1){
        ...
        try {       
            if(obj1.equals("")){
                ...
                Produtos_vetor = bd_Produtos.getProdutosNome(obj1);
            }
            
        } catch (SQLException ex2) {
            Logger.getLogger(ListarProd.class.getName()).log(Level.SEVERE, null, ex2);
        }
        
        
        String dados[][] = new String[Produtos_vetor.length][5];
        ...
        for(int i=0; i < Produtos_vetor.length; i++){
            ...
            dados[i][2] = String.valueOf(esp.getQuantidade());      
