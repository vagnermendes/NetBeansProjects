 ...
 * @author vagner
 */
public class SelecionarClientesRelatorioOS extends javax.swing.JPanel {
    ...
    public SelecionarClientesRelatorioOS(Kernel obj,int acao,Object texto) {
        this.kernel = obj;
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(sp, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 203, Short.MAX_VALUE))
        );
    }// </editor-fold>//GEN-END:initComponents

    private void voltarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_voltarActionPerformed
        // TODO add your handling code here:
        kernel.Tela(29,kernel,0,vetorItem,null);
    ...
    public void TabelaCliente(String obj){
        ...
        try {
            ...
            Logger.getLogger(SelecionarClientesRelatorioOS.class.getName()).log(Level.SEVERE, null, ex2);
        }
         ...
         public void actionPerformed(ActionEvent e)
         {
             ...
             switch(table.getSelectedColumn()){                 
                 case selecionar:                     
                     ...
                     kernel.Tela(29,kernel,id_reg,vetorItem,null);                      
                 break;
                 default:
