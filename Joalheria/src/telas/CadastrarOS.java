...
public class CadastrarOS extends javax.swing.JPanel {
    ...
    private void initComponents() {
                ...
                .add(painel_cadastrar_area3Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(painel_cadastrar_area3Layout.createSequentialGroup()
                        .add(painel_cadastrar_area3Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING, false)
                            ...
                            .add(org.jdesktop.layout.GroupLayout.LEADING, campo_produto, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 174, Short.MAX_VALUE)
                            .add(org.jdesktop.layout.GroupLayout.LEADING, campo_referencia))
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(jLabel3)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                    ...
                    .add(painel_cadastrar_area3Layout.createSequentialGroup()
                        .add(painel_cadastrar_area3Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            ...
                            .add(campo_restante, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 74, Short.MAX_VALUE))
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(painel_cadastrar_area3Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            .add(painel_cadastrar_area3Layout.createSequentialGroup()
                                .add(painel_cadastrar_area3Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                        ...
                        .add(painel_cadastrar_area3Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                            ...
                            .add(getdata, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        ...
        Contaspagar_id.setBackground(new java.awt.Color(255, 241, 88));
        Contaspagar_id.setForeground(new java.awt.Color(255, 241, 88));
        Contaspagar_id.setText("0");

        ordem_servico_id.setForeground(new java.awt.Color(255, 241, 88));
        ...
        servico_id.setForeground(new java.awt.Color(255, 241, 88));
        servico_id.setText("0");

        botao_imprimir.setBackground(new java.awt.Color(255, 241, 88));
        botao_imprimir.setForeground(new java.awt.Color(255, 241, 88));
        ...
        receita.setText("Carregar Receita");
        ...
        layout.setHorizontalGroup(
            ...
            .add(sp, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 852, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(sp, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 287, Short.MAX_VALUE))
        );
    ...
    private void botao_imprimir_termalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botao_imprimir_termalActionPerformed
        // TODO add your handling code here:
        imprimir_termal = new Imprimir_Termal(kernel);
        try {
            imprimir_termal.ImprimirOS(Integer.parseInt(ordem_servico_id.getText()));
        } catch (SQLException ex) {
            Logger.getLogger(CadastrarOS.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void receitaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_receitaActionPerformed
        // TODO add your handling code here:
        obj_Receita = bd_Receita.getReceitaID(Integer.parseInt(cliente_id.getText()));
        String receita = "LONGE:\n";
        receita += "O.D.: \n";
        receita += "ESFÉRICO: "+String.valueOf(obj_Receita.getOdle())+" CLINDRICO: "+String.valueOf(obj_Receita.getOdlc())+"\n";
        receita += "EIXO: "+String.valueOf(obj_Receita.getOdli())+" ADIÇÃO: " +String.valueOf(obj_Receita.getOdla())+"\n";
        receita += "O.E.:"+"\n";
        receita += "ESFÉRICO: "+String.valueOf(obj_Receita.getOele())+" CLINDRICO: "+String.valueOf(obj_Receita.getOelc())+"\n";
        receita += "EIXO: "+String.valueOf(obj_Receita.getOeli())+" ADIÇÃO: " +String.valueOf(obj_Receita.getOela())+"\n";        
        receita += "PERTO:"+"\n";
        receita += "O.D.:"+"\n";
        receita += "ESFÉRICO: "+String.valueOf(obj_Receita.getOdpe())+" CLINDRICO: "+String.valueOf(obj_Receita.getOdpc())+"\n";
        receita += "EIXO: "+String.valueOf(obj_Receita.getOdpi())+" ADIÇÃO: " +String.valueOf(obj_Receita.getOdpa())+"\n";
        receita += "O.E.:"+"\n";
        receita += "ESFÉRICO: "+String.valueOf(obj_Receita.getOepe())+" CLINDRICO: "+String.valueOf(obj_Receita.getOepc())+"\n";
        receita += "EIXO: "+String.valueOf(obj_Receita.getOepi())+" ADIÇÃO: " +String.valueOf(obj_Receita.getOepa())+"\n";
        receita += obj_Receita.getLentes()+"\n";
        receita += obj_Receita.getObservacao()+"\n";
        campo_descricao.setText(receita);
    ...
    private void CalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CalcularActionPerformed
        // TODO add your handling code here:
        campo_restante.setText(fmt.format(Double.parseDouble(campo_entrada.getText().replace(",", "."))-Double.parseDouble(campo_valor.getText().replace(",", "."))));
    ...
    private void SalvarOrdemServico(){        
        ...
        if(ordem_servico_id.getText().equals("0")){
            try {
                ...
                obj_OrdemServico.setValor(Double.parseDouble(campo_entrada.getText().replace(",", ".")));
                obj_OrdemServico.setEntrada(Double.parseDouble(campo_valor.getText().replace(",", ".")));
                obj_OrdemServico.setRestante(Double.parseDouble(campo_restante.getText().replace(",", ".")));
         ...
         public void actionPerformed(ActionEvent e)
         {
             ...
             switch(table.getSelectedColumn()){
                 ...
                 case editar:
                     ...
                     campo_entrada.setText(String.valueOf(new DecimalFormat("#0.00").format(obj_OrdemServico.getValor())));
                     campo_valor.setText(String.valueOf(new DecimalFormat("#0.00").format(obj_OrdemServico.getEntrada())));
