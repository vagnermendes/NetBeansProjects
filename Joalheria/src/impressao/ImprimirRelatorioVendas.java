...
public class ImprimirRelatorioVendas {
    ...
    public void Imprimir(int funcionario_id, String data1,String data2) throws SQLException{
       ...
       if (pj != null) {
          ...
          g.drawString( "Funcioario: "+((obj_Funcionario.getNome()!=null)?obj_Funcionario.getNome():""), 30, 70);
          g.drawString( "------------------------------------------------------------------------------------------", 30, 80);
          ...
          g.drawString("FUNCIONARIO", 400, linha);
          ...
          for(int i=0; i < 47; i++){              
              ...
              g.drawString(esp.getFuncionario().getNome(), 400, linha);
