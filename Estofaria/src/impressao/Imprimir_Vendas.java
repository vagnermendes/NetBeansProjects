    ...
    public void ImprimirVenda(int os) throws SQLException{
       ...
       if (pj != null) {
          ...
          for(int i=0; i < vetor.length; i++){
              ...
              g.drawString(obj_ItemProduto.getProdutos().getNome().substring(0, (obj_ItemProduto.getProdutos().getNome().length()>15)?15:obj_ItemProduto.getProdutos().getNome().length())+" \t\t\t\t\t\t\t\t "+
                            obj_ItemProduto.getQuantidade()+ " \t\t\t\t\t    "+
                            fmt.format((obj_Vendas.getParcelas()!=null)?obj_Vendas.getPreco_venda():((obj_ItemProduto.getProdutos().getIndice()!=0)?((((obj_ItemProduto.getProdutos().getIndice()!=0.0)?((obj_ItemProduto.getProdutos().getIndice())*(obj_ItemProduto.getProdutos().getPeso())):((obj_ItemProduto.getProdutos().getPreco_promocional()!=0.0)?obj_ItemProduto.getProdutos().getPreco_promocional():obj_ItemProduto.getProdutos().getPreco_venda())))*2):((obj_ItemProduto.getProdutos().getPreco_promocional()!=0.0)?obj_ItemProduto.getProdutos().getPreco_promocional():obj_ItemProduto.getProdutos().getPreco_venda()*obj_ItemProduto.getQuantidade()))) , coluna, (linha+=10));
