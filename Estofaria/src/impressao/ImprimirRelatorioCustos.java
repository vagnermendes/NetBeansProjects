 ...
 */
public class ImprimirRelatorioCustos {
    ...
    public ImprimirRelatorioCustos(Kernel kernel){
       this.kernel = kernel;
    ...
    public void Imprimir(int status, String data1,String data2) throws SQLException{
       ...
       if (pj != null) {
          ...
          for(int i=0; i < 47; i++){              
              esp = (Contaspagar)vetor[j];
              g.drawString(String.valueOf(esp.getContas_pagar_id()), 30, linha);
              ...
              g.drawString(String.valueOf(((esp.getStatus()==1)?"Aberto":"Fechado")), 470, linha);
            total += esp.getValor();
            linha = linha+15;
