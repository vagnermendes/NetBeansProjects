...
public class BD_Servico{
    ...
    public void Salvar(Servico obj){
        sql = "insert into "+esquema+"."+tabela+"(nome) values ("+"'"+obj.getNome()+"'"+ ")";
        //////System.out.println(sql);
        kernel.getConexao().Save(sql);
    }

    public void Excluir(int id){
        sql = "delete from "+esquema+"."+tabela+" where Servico_id = "+id;
        kernel.getConexao().Delete(sql);
    }

    public Servico getServicoID(int id){
        try {
            sql = "select * from "+esquema+"."+tabela+" where Servico_id = "+id;
    ...
    public void Atualizar(Servico obj){
        sql = "update "+esquema+"."+tabela+" set nome = '"+obj.getNome()+"' where Servico_id = "+obj.getServico_id();
