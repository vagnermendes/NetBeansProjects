 ...
 * @author vagner
 */
public class ListarFuncionario extends javax.swing.JPanel {
    ...
    public ListarFuncionario(Kernel obj,int acao,Object texto) {
        kernel = obj;
        initComponents();                
        this.Tabela("");
    }
    ...
    private void initComponents() {
        ...
        painel_cadastrar_area3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Lista de Funcionarios", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 3, 14))); // NOI18N
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Pesquisar", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 3, 14))); // NOI18N
        ...
        layout.setVerticalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(sp, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 243, Short.MAX_VALUE))
        );
    }// </editor-fold>//GEN-END:initComponents

    private void adicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_adicionarActionPerformed
        // TODO add your handling code here:
        kernel.Tela(14,null,0,null,null);
    ...
    public void Tabela(String obj){
        ...
        try {       
            if(obj.equals("")){
                ...
                Funcionario_vetor = bd_Funcionario.getFuncionarioNome(obj);
            }
            
        } catch (SQLException ex2) {
            Logger.getLogger(ListarFuncionario.class.getName()).log(Level.SEVERE, null, ex2);
        }
        
        
        String dados[][] = new String[Funcionario_vetor.length][4];

        Funcionario esp = new Funcionario();
        for(int i=0; i < Funcionario_vetor.length; i++){
            esp = (Funcionario)Funcionario_vetor[i];
            dados[i][0] = String.valueOf(esp.getFuncionario_id());
        ...
        ButtonColumnFuncionario buttonColumnFuncionario1 = new ButtonColumnFuncionario(tabela, editar);//EDITAR
        ButtonColumnFuncionario buttonColumnFuncionario2 = new ButtonColumnFuncionario(tabela, excluir);//EXCLUIR
    }

    //CLASSE BUTTONCOLUMN Funcionario
    class ButtonColumnFuncionario extends AbstractCellEditor
         implements TableCellRenderer, TableCellEditor, ActionListener
     {
         ...
         public ButtonColumnFuncionario(JTable table, int column)
         {
             super();
             this.table = table;
    ...
    private void SolicitaConfirmacaoFuncionario(){
    ...
    int resposta = JOptionPane.showOptionDialog(this,
     ...
     if (resposta == 0) {
       bd_Funcionario.Excluir(Integer.parseInt(tabela.getValueAt(tabela.getSelectedRow(),0).toString()));
     }
