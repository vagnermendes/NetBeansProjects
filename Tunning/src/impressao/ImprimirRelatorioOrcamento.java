 ...
 */
public class ImprimirRelatorioOrcamento {

    private Orcamento     obj_Contaspagar      = null;
    private Kernel          kernel          = null;    
    private BD_Orcamento  bd_Contaspagar       = null;
    private DecimalFormat fmt;
    
    public ImprimirRelatorioOrcamento(Kernel kernel){
       this.kernel = kernel;
       bd_Contaspagar = new BD_Orcamento(kernel);
    }
    
    public void Imprimir(int status, String data1,String data2) throws SQLException{
        
        Orcamento[] vetor = null;
       ...
       Frame f = new Frame("Relatório de Contaspagar");
       f.pack();
       ...
       if (pj != null) {
          ...
          for(int i=0; i < 47; i++){              
              esp = (Orcamento)vetor[j];
              g.drawString(String.valueOf(esp.getOrcamento_id()), 30, linha);
              g.drawString(String.valueOf(esp.getCliente()), 60, linha);
